  ...
  button.addEventListener('click', () => {
    ...
    switch (buttonValue) {
      ...
      case 'C':
        ...
        break;
      case 'sin':
        inputField.value = Math.sin(parseFloat(eval(inputField.value))).toFixed(2);
        inputString = inputField.value.toString();
        break;
      case 'cos':
        inputField.value = Math.cos(parseFloat(eval(inputField.value))).toFixed(2);
        inputString = inputField.value.toString();
        break;
      case 'tan':
        inputField.value = Math.tan(parseFloat(eval(inputField.value))).toFixed(2);
        inputString = inputField.value.toString();
        break;
      case '√':
      ...
      case 'ABS':
        ...
        inputField.value = Math.abs(eval(inputField.value)).toFixed(2);
        inputString = inputField.value.toString();
        break;
      case 'CE':
